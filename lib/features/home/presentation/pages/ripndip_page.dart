...
class RipNdipPage extends StatefulWidget {
  const RipNdipPage({super.key});

  @override
  State<RipNdipPage> createState() => _RipNdipPageState();
}

class _RipNdipPageState extends State<RipNdipPage> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<BrandController>().loadProductsByBrand('RipNdip');
    });
  }
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            onPressed: () {
                              ...
                              controller.loadProductsByBrand('RipNdip');
                            },
                        ...
                        if (controller.products.isEmpty)
                          Center(
                            child: Padding(
                              ...
                              child: Text(
                                "No hay productos disponibles para RipNdip",
                                style: AppTypography.bodyMono.copyWith(
